...
import { TESTNET_NODE_RPC, TESTNET_NODE_WS } from '../config'
import { RPCEvent } from './types'
import DaemonWS from './websocket'

const RUN_WS_TESTS = process.env.RUN_TOS_DAEMON_WS_TESTS === 'true'
const describeDaemonWS = RUN_WS_TESTS ? describe : describe.skip

describeDaemonWS('DaemonWS', () => {
  test('getInfo', async () => {
